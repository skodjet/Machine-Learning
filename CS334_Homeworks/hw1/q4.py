...
def standard_scale(xTrain, xTest):
    ...
    xTrain_mean = xTrain_scaler.mean_
    xTrain_var = xTrain_scaler.var_

    xTrain = xTrain_scaled

    # Apply xTrain transformation to xTest
    ...
    xTest = pd.DataFrame(xTest_numpy, columns=["fixed acidity", "volatile acidity", "citric acid", "residual sugar",
