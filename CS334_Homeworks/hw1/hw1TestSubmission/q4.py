...
def standard_scale(xTrain, xTest):
    ...
    # Use sklearn StandardScaler to transform xTrain
    xTrain_scaler = preprocessing.StandardScaler()
    xTrain_scaled = xTrain_scaler.fit_transform(xTrain)
    xTrain = xTrain_scaled

    # Scale xTest with the values used to scale xTrain
    xTest_scaled = xTrain_scaler.fit_transform(xTest)
    xTest = xTest_scaled
...
def minmax_range(xTrain, xTest):
    ...
    # Scale xTrain using the MinMaxScaler
    xTrain_scaler = preprocessing.MinMaxScaler()
    xTrain_scaled = xTrain_scaler.fit_transform(xTrain)
    xTrain = xTrain_scaled

    # Scale xTest based on the parameters given for xTrain
    xTest_scaled = xTrain_scaler.fit_transform(xTest)
    xTest = xTest_scaled
